...
describe("QuizGame", () => {
  ...
  let computerPlayerAskQuestionSpy;
  let timer;

  beforeEach(() => {
    quizGame = QuizGame({
      human: humanPlayer,
      computer: googleVisionPlayer,
      mode: peopleMode,
    ...
    computerPlayerAskQuestionSpy = jest.spyOn(googleVisionPlayer, "askQuestion");
  ...
  describe("when start the game", () => {
    ...
    it("computer player should be asked to answer first question", () => {
      expect(computerPlayerAskQuestionSpy).toBeCalled()
    })
